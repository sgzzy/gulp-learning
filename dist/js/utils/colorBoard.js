...
ColorBoard.prototype = {
   ...
   * @param {Array} value
   */
  setData: function setData(imageData, x, y, value) {
   ...
   * @param rgb
   */
  drawColor: function drawColor(r, startAngle, rgb) {
    var context = this;
    var ctx = context.ctx;
  ...
  drawLight: function drawLight(h, s) {
    var context = this;
   ...
   * @returns {string}
   */
  colorRgb: function colorRgb(hex) {
